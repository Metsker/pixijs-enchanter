export const en: Record<string, string> = {
  ...
  'inspector.recolor': 'Recolour · 💎 {cost}',
  'inspector.recolor.hint': 'Recolours this socket for 💎 {cost}. A gem that no longer fits is sent to your backpack.',
  'inspector.recolor.red': 'Red socket (weapon gems)',
  'inspector.recolor.green': 'Green socket (armor gems)',
  'inspector.recolor.blue': 'Blue socket (jewelry gems)',
